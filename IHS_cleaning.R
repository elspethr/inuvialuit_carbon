...
for (vill in villages) {
  a <- FALSE
  if (paste0("JS_Harvest_Point_", vill, "_2018.LAYER.0.csv") %in% list.files(path="points_2018")) {
    a <- TRUE
    dat1 <- read.csv(paste0("points_2018/JS_Harvest_Point_", vill, "_2018.LAYER.0.csv"),
  ...
  if (paste0("JS_Harvest_", vill, "_Point_2018.LAYER.0.csv") %in% list.files("points_2018")) {
    dat2 <- read.csv(paste0("points_2018/JS_Harvest_",  vill, "_Point_2018.LAYER.0.csv"),
                     stringsAsFactors = FALSE)
...
write.csv(harvest2018, "harvest2018_cleaned.csv")
